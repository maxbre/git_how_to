...
figure re-drawn upon the original model: http://rogerdudler.github.io/git-guide/
...
create a new local repository with a given name
```
git init
```
create a new local repository with a given name
...
git add .
```
that point after *git add* means all files present in the repository
...
upload local commit to remote repository
```
