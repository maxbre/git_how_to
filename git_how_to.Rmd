...
git init
```
this command creates a new subdirectory named *.git* inside an existing working directory
...
it is always a good practice to check the status of the files inside the repository and this is simply done by issuing the following command:
...
THIS PART MUST BE WORKED OUT & REVIEWED...

```
echo "# git_how_to" >> README.md
git init
git add README.md
git commit -m "first commit"
git remote add origin https://github.com/maxbre/git_how_to.git
git push -u origin master
